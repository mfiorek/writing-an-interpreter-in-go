...
type LetStatement struct {
	...
	Name  *Identifier
	// NOTE: Identifier implements Expression - as Thornsten said "to keep things simple"...
	// There are Identifiers that do "produce a value" so we treat them as expressions
	Value Expression
}
...
type ExpressionStatement struct {
	Token      token.Token // first token of the expression (tho I don't know what for...)
...
// INFO: BlockStatement - needed in ifExpression and functionLiteral
...
func (hl *HashLiteral) Ast() string { return "not-implemented" } // TODO: implement
